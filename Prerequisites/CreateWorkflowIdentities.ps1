...
$testResourceGroup = New-AzResourceGroup -Name ToyWebsiteEndToEndTest -Location westeurope
...
$productionResourceGroup = New-AzResourceGroup -Name ToyWebsiteEndToEndProduction -Location westeurope
